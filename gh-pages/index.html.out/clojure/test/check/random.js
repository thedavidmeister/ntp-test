...
var x__9171__auto__ = (((rng == null))?null:rng);
var m__9172__auto__ = (clojure.test.check.random.rand_long[goog.typeOf(x__9171__auto__)]);
if(!((m__9172__auto__ == null))){
return (m__9172__auto__.cljs$core$IFn$_invoke$arity$1 ? m__9172__auto__.cljs$core$IFn$_invoke$arity$1(rng) : m__9172__auto__.call(null,rng));
} else {
var m__9172__auto____$1 = (clojure.test.check.random.rand_long["_"]);
if(!((m__9172__auto____$1 == null))){
return (m__9172__auto____$1.cljs$core$IFn$_invoke$arity$1 ? m__9172__auto____$1.cljs$core$IFn$_invoke$arity$1(rng) : m__9172__auto____$1.call(null,rng));
} else {
...
var x__9171__auto__ = (((rng == null))?null:rng);
var m__9172__auto__ = (clojure.test.check.random.rand_double[goog.typeOf(x__9171__auto__)]);
if(!((m__9172__auto__ == null))){
return (m__9172__auto__.cljs$core$IFn$_invoke$arity$1 ? m__9172__auto__.cljs$core$IFn$_invoke$arity$1(rng) : m__9172__auto__.call(null,rng));
} else {
var m__9172__auto____$1 = (clojure.test.check.random.rand_double["_"]);
if(!((m__9172__auto____$1 == null))){
return (m__9172__auto____$1.cljs$core$IFn$_invoke$arity$1 ? m__9172__auto____$1.cljs$core$IFn$_invoke$arity$1(rng) : m__9172__auto____$1.call(null,rng));
} else {
...
var x__9171__auto__ = (((rng == null))?null:rng);
var m__9172__auto__ = (clojure.test.check.random.split[goog.typeOf(x__9171__auto__)]);
if(!((m__9172__auto__ == null))){
return (m__9172__auto__.cljs$core$IFn$_invoke$arity$1 ? m__9172__auto__.cljs$core$IFn$_invoke$arity$1(rng) : m__9172__auto__.call(null,rng));
} else {
var m__9172__auto____$1 = (clojure.test.check.random.split["_"]);
if(!((m__9172__auto____$1 == null))){
return (m__9172__auto____$1.cljs$core$IFn$_invoke$arity$1 ? m__9172__auto____$1.cljs$core$IFn$_invoke$arity$1(rng) : m__9172__auto____$1.call(null,rng));
} else {
...
var x__9171__auto__ = (((rng == null))?null:rng);
var m__9172__auto__ = (clojure.test.check.random.split_n[goog.typeOf(x__9171__auto__)]);
if(!((m__9172__auto__ == null))){
return (m__9172__auto__.cljs$core$IFn$_invoke$arity$2 ? m__9172__auto__.cljs$core$IFn$_invoke$arity$2(rng,n) : m__9172__auto__.call(null,rng,n));
} else {
var m__9172__auto____$1 = (clojure.test.check.random.split_n["_"]);
if(!((m__9172__auto____$1 == null))){
return (m__9172__auto____$1.cljs$core$IFn$_invoke$arity$2 ? m__9172__auto____$1.cljs$core$IFn$_invoke$arity$2(rng,n) : m__9172__auto____$1.call(null,rng,n));
} else {
...
var G__16833 = z;
if(((24) > (function (){var G__16834 = clojure.test.check.random.bxoubsr(z,(1));
return (clojure.test.check.random.longs.bit_count.cljs$core$IFn$_invoke$arity$1 ? clojure.test.check.random.longs.bit_count.cljs$core$IFn$_invoke$arity$1(G__16834) : clojure.test.check.random.longs.bit_count.call(null,G__16834));
})())){
return clojure.test.check.random.longs.bit_xor(G__16833,clojure.test.check.random.mix_gamma_const_3);
} else {
return G__16833;
}
});
...
var G__16837 = state_SINGLEQUOTE__SINGLEQUOTE_;
var G__16838 = cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(ret,new_rng);
state__$1 = G__16837;
ret = G__16838;
continue;
}
...
clojure.test.check.random.JavaUtilSplittableRandom.cljs$lang$ctorPrWriter = (function (this__9109__auto__,writer__9110__auto__,opt__9111__auto__){
return cljs.core._write(writer__9110__auto__,"clojure.test.check.random/JavaUtilSplittableRandom");
});
...
return (new clojure.test.check.random.JavaUtilSplittableRandom(clojure.test.check.random.golden_gamma,(function (){var or__8438__auto__ = clojure.test.check.random.longs.__GT_long(seed);
...
var state = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__16840__$1,cljs.core.cst$kw$state);
var vec__16842 = clojure.test.check.random.split(state);
var r1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16842,(0),null);
var r2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16842,(1),null);
