...
ajax.simple.base_handler = (function ajax$simple$base_handler(interceptors,p__16053){
...
var handler = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__16054__$1,cljs.core.cst$kw$handler);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$variadic(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [response_format], null),(function (){var or__8438__auto__ = p1__16056_SHARP_;
...
ajax.simple.raw_ajax_request = (function ajax$simple$raw_ajax_request(p__16057){
...
var request = map__16058__$1;
var interceptors = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__16058__$1,cljs.core.cst$kw$interceptors);
...
var api = (function (){var or__8438__auto__ = cljs.core.cst$kw$api.cljs$core$IFn$_invoke$arity$1(request__$1);
if(cljs.core.truth_(or__8438__auto__)){
return or__8438__auto__;
} else {
