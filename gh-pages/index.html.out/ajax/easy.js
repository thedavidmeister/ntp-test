...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first(format),(function (){var G__16067 = cljs.core.second(format);
var G__16068 = format_params;
return (ajax.easy.keyword_response_format_element.cljs$core$IFn$_invoke$arity$2 ? ajax.easy.keyword_response_format_element.cljs$core$IFn$_invoke$arity$2(G__16067,G__16068) : ajax.easy.keyword_response_format_element.call(null,G__16067,G__16068));
})()], null);
} else {
if(cljs.core.map_QMARK_(format)){
return format;
...
var G__16069 = format;
var G__16069__$1 = (((G__16069 instanceof cljs.core.Keyword))?G__16069.fqn:null);
switch (G__16069__$1) {
case "transit":
...
if(cljs.core.vector_QMARK_(format)){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.vector,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__16071_SHARP_){
return ajax.easy.keyword_response_format_element(p1__16071_SHARP_,format_params);
}),format));
} else {
 ...
 */
ajax.easy.transform_handler = (function ajax$easy$transform_handler(p__16072){
...
var handler = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__16073__$1,cljs.core.cst$kw$handler);
var error_handler = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__16073__$1,cljs.core.cst$kw$error_DASH_handler);
var finally$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__16073__$1,cljs.core.cst$kw$finally);
var h = (function (){var or__8438__auto__ = handler;
...
var e = (function (){var or__8438__auto__ = error_handler;
if(cljs.core.truth_(or__8438__auto__)){
return or__8438__auto__;
} else {
...
return ((function (h,e,map__16073,map__16073__$1,handler,error_handler,finally$){
return (function ajax$easy$transform_handler_$_easy_handler(p__16075){
var vec__16076 = p__16075;
var ok = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16076,(0),null);
var result = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16076,(1),null);
var fexpr__16079_16080 = (cljs.core.truth_(ok)?h:e);
(fexpr__16079_16080.cljs$core$IFn$_invoke$arity$1 ? fexpr__16079_16080.cljs$core$IFn$_invoke$arity$1(result) : fexpr__16079_16080.call(null,result));
...
;})(h,e,map__16073,map__16073__$1,handler,error_handler,finally$))
});
ajax.easy.transform_opts = (function ajax$easy$transform_opts(p__16081){
...
var opts = map__16082__$1;
var method = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__16082__$1,cljs.core.cst$kw$method);
var format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__16082__$1,cljs.core.cst$kw$format);
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__16082__$1,cljs.core.cst$kw$response_DASH_format);
var params = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__16082__$1,cljs.core.cst$kw$params);
var body = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__16082__$1,cljs.core.cst$kw$body);

var needs_format = ((body == null)) && (cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(method,"GET"));
var rf = (cljs.core.truth_((function (){var or__8438__auto__ = format;
if(cljs.core.truth_(or__8438__auto__)){
return or__8438__auto__;
} else {
return needs_format;
